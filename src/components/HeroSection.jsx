            ...
            <div className="container max-w-4xl mx-auto text-center z-10">
                <div className="space-y-6">
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground max-2-2xl mx-auto opacity-0 animate-fade-in-delayed-3">
                        I like stars and the sky and the night.
                        Practicing for my university's project drawing them right now.
                        okay I don't know what else to write. Oh holy cow I just made my portfolio
                    </p>
